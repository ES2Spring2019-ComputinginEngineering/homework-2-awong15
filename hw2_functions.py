...
# In this homework,the ultimate goal is to create a function
# called areaofatriangle,
...
# where two lines intersect (x and y), a function which determines
...
# This line allows you to use math functions.
# Importantly, math.sqrt(#) which will produce the square root of the
...
def areaofatriangle(m1, b1, m2, b2, m3, b3):
    ...
    if ((x1 == x2 and x1 == x3 and x2 == x3) or
